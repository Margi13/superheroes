...
export const validationMessages = {
    ...
    'ImageSize': 'Изображението трябва да бъде най-много 2 МВ',
    'ComicsSize': 'Комиксът трябва да бъде най-много 100 МВ',
    'ImagesFormat': 'Изображенията трябва да са във валиден формат (.jpg, .jpeg, .bmp, .gif, .png)',
