...
const Create = () => {
    ...
    const onHeroCreate = async (e) => {
        ...
        supereroService.create(heroData, image.img)
        .then(() => {
        ...
        <section id="create-page" className="auth">
            <form id="create" method="POST" onSubmit={onHeroCreate}>
                <div className="container">
                    ...
                    <input type="file" id="imageUrl" name="imageUrl" placeholder={placeholdersBG.Image} onChange={imageHandler} className={errors.image ? 'error' : 'no-error'} />
