...
export const generateRequestDocument = ( document ) => {
...
const createMainText = (document) => {
    const text = [
        ...
        `ПОДАТЕЛЯТ моли за разрешение да получи права за използване на ${document.requestedDataType} с ИН: ${document._dataId}, който принадлежи на СОБСТВЕНИКА в свой ${document.newDataType === 'comics' ? "комикс" : "герой"}, като изпраща следното съобщение:`,
    ];
